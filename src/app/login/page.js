...
export default async function LoginPage({ searchParams }) {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-gray-50 rounded-2xl shadow-lg border border-gray-200 p-8 space-y-6">
        <div className="text-center">
        ...
        <form action={login} className="space-y-4">
          <input
            ...
            placeholder="Email"
            required
            className="w-full px-4 py-3 rounded-lg bg-white border border-gray-300 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none"
          />
          <input
            name="password"
            type="password"
        ...
        <form action={signup} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-gray-300 text-gray-900 font-semibold py-3 rounded-lg hover:bg-gray-400 transition duration-200"
          >
            Sign Up
          </button>
        </form>
